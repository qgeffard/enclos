...
import org.enclos.component.EnclosMenu;
...
public class Speaker {
	...
	static {
		...
		// STEP
		Speaker.stepSheep.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/step1.wav")));
		Speaker.stepSheep.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/step2.wav")));
		Speaker.stepSheep.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/step3.wav")));
		Speaker.stepSheep.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/step4.wav")));
		Speaker.stepSheep.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/step5.wav")));
		...
		// Hover event
		Speaker.hoverEvent.add(Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/stone1.wav")));

		// Click
		Speaker.click = Applet.newAudioClip(Speaker.class.getResource("/org/enclos/resources/song/click.wav"));
