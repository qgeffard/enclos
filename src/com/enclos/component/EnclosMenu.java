...
public class EnclosMenu extends JMenuBar {
    ...
    public void addSubItems(JMenu menu) {
        ...
        // addPlayerItemListener(playerItem);
    ...
    /*
     * private void addPlayerItemListener(JMenuItem playerItem) { playerItem.addActionListener(new ActionListener() {
     * 
     * @Override public void actionPerformed(ActionEvent e) { Speaker.playClickEvent(); PlayersFrame playersFrame = new PlayersFrame(); } }); }
     */
