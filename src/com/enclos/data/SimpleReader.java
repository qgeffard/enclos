...
public class SimpleReader {
	...
	public SimpleReader(String fileName) {
		...
		try {
			this.file = parser.parse(new FileReader("resources/save/"
					+ fileName + ".json"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	/*
	 * public Map<String,Object> read(){ Map<String,Object> values = new
	 * HashMap<String,Object>(); try { JSONObject reader = (JSONObject) file;
	 * 
	 * for(Params param : Params.values()){ Object value =
	 * reader.get(param.toString()); values.put(param.toString(),value); } }
	 * catch (Exception e) { e.printStackTrace(); } return values; }
	 */
	...
	public static Map<String, Object> readGame(String fileName) {
		...
		try {
			targetFile = parser.parse(new FileReader("resources/save/"
					+ fileName + ".json"));
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static List<Player> readPlayer(String fileName) {
		...
		Object targetFile = null;
		try {
			targetFile = parser.parse(new FileReader("resources/players/"
					+ fileName + ".json"));
		} catch (Exception e) {
			e.printStackTrace();
		}
